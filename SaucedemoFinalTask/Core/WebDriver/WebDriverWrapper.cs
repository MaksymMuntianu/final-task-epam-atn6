...
{
    /// <summary>Thread-local singleton instance of WebDriverWrapper.</summary>
    ...
    /// <summary>Initializes a new instance of the WebDriverWrapper class.</summary>
    ...
    public static WebDriverWrapper GetInstance(BrowserType browserType) =>
        Instance.Value ?? (Instance.Value = new WebDriverWrapper(browserType));
