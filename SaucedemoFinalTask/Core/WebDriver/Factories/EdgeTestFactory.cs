...
internal class EdgeTestFactory : ITestFactory
{
    ...
    /// <remarks>The returned <see cref="IWebDriver"/> instance is configured with default settings,
    /// including disabling informational bars in the browser, and launching the browser in InPrivate mode.
    /// The method uses a default timeout of 30 seconds for browser initialization.</remarks>
