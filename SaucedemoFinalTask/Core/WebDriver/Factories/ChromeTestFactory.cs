...
internal class ChromeTestFactory : ITestFactory
{
    ...
    /// <remarks>The WebDriver is configured with default settings, including incognito mode and the
    /// "disable-infobars" argument. The method uses a default ChromeDriverService and applies a 30-second command
    /// timeout.</remarks>
