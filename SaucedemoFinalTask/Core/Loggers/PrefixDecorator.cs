...
/// <remarks>This class wraps an existing <see cref="ILoggerAdapter"/> instance and prepends a prefix to each log
/// message before delegating the call to the inner logger. The prefix is trimmed to ensure no leading or trailing
/// whitespace in the final log message.</remarks>
...
/// <param name="prefix">The prefix to prepend to each log message. If the prefix is empty or consists only of whitespace, it will be ignored.</param>
