...
/// <summary>Provides a factory for creating logger instances based on the specified logger type.</summary>
/// <remarks>
///     This class simplifies the creation of loggers by abstracting the instantiation of specific logger
///     implementations. Use the <see cref="CreateLogger" /> method to obtain an instance of a logger adapter corresponding
///     to the desired logging framework.
/// </remarks>
public class LoggerFactory
{
    ...
    ///     Thrown if the <paramref name="loggerType" /> is not a recognized <see cref="LoggerType" /> value.
    /// </exception>
