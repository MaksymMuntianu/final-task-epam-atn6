...
/// <summary>Provides a builder for creating and configuring an <see cref="ILoggerAdapter" /> instance.</summary>
/// <remarks>
///     The <see cref="LoggerBuilder" /> class allows for the step-by-step configuration of a logger by
///     applying optional decorators, such as a prefix or a repeat guard, before building the final <see cref="ILoggerAdapter" /> instance.
/// </remarks>
...
public class LoggerBuilder(LoggerType loggerType)
{
    ...
    /// <remarks>
    ///     This method decorates the current logger with a <see cref="RepeatGuardDecorator" />,  which
    ///     ensures that repeated log messages are filtered out. Use this method to  enhance logging behavior by avoiding redundant log entries.
    /// </remarks>
    /// <returns>The current <see cref="LoggerBuilder" /> instance, allowing for method chaining.</returns>
    ...
    public ILoggerAdapter Build() => _logger;
}