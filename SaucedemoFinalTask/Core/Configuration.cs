...
/// <summary>Represents the configuration settings for the application, including browser type, logger type, and application URL.</summary>
...
public class Configuration(IConfiguration configuration)
{
    ...
    /// <summary>Gets the URL of the application to be tested. Defaults to "https://www.saucedemo.com/" if not specified in the configuration.</summary>
